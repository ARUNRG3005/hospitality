      ...
      <header className="relative h-[716px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 animate-rise">
          ...
          <h1 className="font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-8 max-w-4xl mx-auto">
            Curated Aesthetics for the Discerning
          </h1>
      ...
      <main className="max-w-container-max mx-auto px-6 md:px-20 py-20 md:py-40">
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8 reveal">
          <div className="max-w-2xl">
            <h2 className="font-headline-md text-headline-md text-primary mb-4">Treatment Directory</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant">
              A sanctuary where medical precision meets aesthetic harmony. Explore our comprehensive suite of advanced clinical treatments designed for lasting rejuvenation.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-16 gap-x-8 reveal">
          ...
          <div className="treatment-card-hover group flex flex-col cursor-pointer transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="px-2">
              <span className="font-label-caps text-label-caps text-secondary/60 mb-2 block">Dermatology</span>
              <h3 className="font-headline-sm text-headline-sm text-primary mb-3">Acne Treatment</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-2">
                Precision protocols to clear inflammation and restore epidermal integrity through medical-grade light therapy and peels.
              </p>
              <Link to="/booking" className="font-label-caps text-label-caps text-primary border-b border-primary/20 pb-1 inline-block hover:border-primary transition-all">
                Explore Procedure &amp; Book
              </Link>
            </div>
          </div>
          ...
          <div className="treatment-card-hover group flex flex-col cursor-pointer transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="px-2">
              <span className="font-label-caps text-label-caps text-secondary/60 mb-2 block">Corrective</span>
              <h3 className="font-headline-sm text-headline-sm text-primary mb-3">Pigmentation Removal</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-2">
                Advanced laser systems targeting melanin clusters to reveal an even, luminous complexion without downtime.
              </p>
              <Link to="/booking" className="font-label-caps text-label-caps text-primary border-b border-primary/20 pb-1 inline-block hover:border-primary transition-all">
                Explore Procedure &amp; Book
              </Link>
          ...
          <div className="treatment-card-hover group flex flex-col cursor-pointer transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="px-2">
              <span className="font-label-caps text-label-caps text-secondary/60 mb-2 block">Regenerative</span>
              <h3 className="font-headline-sm text-headline-sm text-primary mb-3">Skin Rejuvenation</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-2">
                Stimulating collagen architecture through micro-needling and proprietary growth factor serums for profound texture refinement.
              </p>
              <Link to="/booking" className="font-label-caps text-label-caps text-primary border-b border-primary/20 pb-1 inline-block hover:border-primary transition-all">
                Explore Procedure &amp; Book
              </Link>
          ...
          <div className="treatment-card-hover group flex flex-col cursor-pointer transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="px-2">
              <span className="font-label-caps text-label-caps text-secondary/60 mb-2 block">Laser</span>
              <h3 className="font-headline-sm text-headline-sm text-primary mb-3">Laser Hair Removal</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-2">
                Medical-grade Alexandrite technology providing permanent reduction with integrated cooling for maximum patient comfort.
              </p>
              <Link to="/booking" className="font-label-caps text-label-caps text-primary border-b border-primary/20 pb-1 inline-block hover:border-primary transition-all">
                Explore Procedure &amp; Book
              </Link>
          ...
          <div className="treatment-card-hover group flex flex-col cursor-pointer transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="px-2">
              <span className="font-label-caps text-label-caps text-secondary/60 mb-2 block">Injectables</span>
              <h3 className="font-headline-sm text-headline-sm text-primary mb-3">Botox &amp; Fillers</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-2">
                Expert facial mapping and micro-dose injectables to smooth fine lines and restore volume with an emphasis on subtle, natural results.
              </p>
              <Link to="/booking" className="font-label-caps text-label-caps text-primary border-b border-primary/20 pb-1 inline-block hover:border-primary transition-all">
                Explore Procedure &amp; Book
              </Link>
          ...
          <div className="treatment-card-hover group flex flex-col cursor-pointer transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="px-2">
              <span className="font-label-caps text-label-caps text-secondary/60 mb-2 block">Body</span>
              <h3 className="font-headline-sm text-headline-sm text-primary mb-3">Body Contouring</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 line-clamp-2">
                Non-invasive thermal and cryogenic technologies designed to sculpt the physique and tighten epidermal laxity for refined silhouettes.
              </p>
              <Link to="/booking" className="font-label-caps text-label-caps text-primary border-b border-primary/20 pb-1 inline-block hover:border-primary transition-all">
                Explore Procedure &amp; Book
              </Link>
        ...
        <div className="mt-32 pt-32 border-t border-secondary/10 reveal">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="glass-card p-12 flex flex-col justify-center">
              <h4 className="font-headline-sm text-headline-sm text-primary mb-6">Bespoke Clinical Facials</h4>
              <p className="font-body-lg text-body-lg text-on-surface-variant mb-8">
                Each session begins with a microscopic skin analysis, followed by a curated selection of chemical peels and botanical infusions tailored to your unique cellular profile.
              </p>
              <div className="flex flex-wrap gap-4">
                <span className="px-4 py-2 bg-secondary/5 border border-secondary/20 font-label-caps text-label-caps text-secondary">Chemical Peels</span>
                <span className="px-4 py-2 bg-secondary/5 border border-secondary/20 font-label-caps text-label-caps text-secondary">Hydra-Infusion</span>
                <span className="px-4 py-2 bg-secondary/5 border border-secondary/20 font-label-caps text-label-caps text-secondary">LED Phototherapy</span>
              </div>
            </div>
            <div className="relative aspect-video overflow-hidden border-[0.5px] border-[#D4AF37]/30">
              <img
                className="w-full h-full object-cover transition-transform duration-[2s] hover:scale-105"
                alt="Water droplet ripple"
      ...
      <section className="bg-primary py-40 px-6 text-center relative overflow-hidden reveal">
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          ...
          <p className="font-body-lg text-body-lg text-primary-fixed-dim mb-12 opacity-80">
            Consult with our elite clinical team to develop a personalized treatment pathway tailored to your specific goals.
          </p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Link to="/booking" className="px-12 py-5 bg-secondary text-on-secondary font-body-md text-body-md border border-[#D4AF37] hover:bg-secondary-container hover:scale-105 transition-all duration-300 flex items-center justify-center shadow-lg">
              Book Consultation
            </Link>
            <Link to="/services" className="px-12 py-5 bg-transparent text-[#D4AF37] font-body-md text-body-md border border-[#D4AF37] hover:bg-[#D4AF37]/5 hover:scale-105 transition-all duration-300 flex items-center justify-center">
              Treatment Guide
            </Link>
          </div>
        </div>
