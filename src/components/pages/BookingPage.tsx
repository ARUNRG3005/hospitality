  ...
  return (
    <div className="font-body-md text-on-surface min-h-screen">
      ...
      <main className="pt-32 pb-20 px-6 md:px-20 max-w-container-max mx-auto min-h-screen flex flex-col items-center">
        {/* Booking Container */}
        <div
          className="w-full max-w-4xl glass-container rounded-xl p-8 md:p-16 shadow-2xl relative overflow-hidden min-h-[600px] flex flex-col"
          id="booking-flow"
        >
          {/* Step Header */}
          <div className="mb-12" id="step-info">
            <span className="font-label-caps text-label-caps gold-text mb-2 block uppercase">
              Step <span id="current-step-num">{currentStep}</span> of 5
            </span>
            <h1 className="font-display-lg text-headline-md text-primary" id="step-title">
              ...
              {currentStep === 5 && "Appointment Confirmed"}
            </h1>
          </div>

          {/* Step 1: Select Department */}
          <div
            className={`step-content space-y-4 ${currentStep === 1 ? "" : "hidden"}`}
            id="step-1"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button
                className="group text-left p-6 gold-border bg-white/30 hover:bg-white/60 transition-all duration-300 rounded-lg flex justify-between items-center"
                onClick={() => nextStep(2)}
              >
                <div>
                  ...
                  <p className="text-on-surface-variant font-body-md text-body-md">
                    Comprehensive medical evaluation and health guidance.
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <p className="text-on-surface-variant font-body-md text-body-md">
                    Pre-operative evaluation and surgical consults.
                  </p>
                </div>
                <span className="material-symbols-outlined text-secondary opacity-0 group-hover:opacity-100 transition-all">
                  arrow_forward_ios
              ...
              >
                <div>
                  ...
                  <p className="text-on-surface-variant font-body-md text-body-md">
                    Advanced heart screenings and cardiovascular diagnostics.
                  </p>
                </div>
                <span className="material-symbols-outlined text-secondary opacity-0 group-hover:opacity-100 transition-all">
                  arrow_forward_ios
              ...
              >
                <div>
                  ...
                  <p className="text-on-surface-variant font-body-md text-body-md">
                    Preventive physical exams and comprehensive lab screens.
                  </p>
                </div>
                <span className="material-symbols-outlined text-secondary opacity-0 group-hover:opacity-100 transition-all">
                  arrow_forward_ios
          ...
          <div
            className={`step-content space-y-8 ${currentStep === 2 ? "" : "hidden"}`}
            id="step-2"
          >
              ...
              >
                <div className="w-40 h-52 bg-surface-container rounded-full overflow-hidden border border-secondary/20 relative group-hover:border-secondary transition-all">
                  <img
                    className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500"
                    alt="Dr. Arjun Mehta"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbRDL9zzvmnnlPYMSMqucuVkamSUD7T48hVu05lJGsrIRcVyqwANmKm6LxILwLxAgLAmbl6fFyhnbLqQdeCVSW6dEyfBp_LdfVo0l58jCbiF-HFfuhQzUInMs73DS8Mui1pBYxvDXwENKJUIZFZ2GNELglSNQpCkrBlu6UfIm9pY3nfzM2j40PB4IJpop0cWdc91mefhClXjqad3lllaKNfSTt4KWC2b6xvxgcsAfAJYvSkbd3Mc0i5_CfZloYvL2eC4DEl2Ii0Io"
                  />
                </div>
                <div>
          ...
          {/* TODO: Replace with custom calendar or react-day-picker when fully integrated */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="gold-border rounded-xl p-6 bg-white/20">
                ...
                <div className="grid grid-cols-7 gap-y-4 text-center">
                  ...
                  <button className="py-2 hover:bg-secondary/10 rounded-full transition-all">
                    01
                  </button>
                  <button className="py-2 hover:bg-secondary/10 rounded-full transition-all">
                    02
                  ...
                  <button className="py-2 bg-primary text-on-primary rounded-full shadow-lg font-bold">
                    15
                  </button>
                  <button className="py-2 hover:bg-secondary/10 rounded-full transition-all">
                    16
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    className="py-4 text-center border border-secondary/30 rounded-lg hover:bg-secondary hover:text-on-secondary transition-all font-body-md cursor-pointer"
                    onClick={() => nextStep(4)}
                  >
                    09:00 AM
                  </button>
          ...
          <div
            className={`step-content max-w-lg mx-auto w-full ${currentStep === 4 ? "" : "hidden"}`}
            id="step-4"
          >
            <form
          ...
          {/* Step 5: Confirmation */}
          <div
            className={`step-content flex flex-col items-center justify-center text-center space-y-8 py-10 ${currentStep === 5 ? "" : "hidden"}`}
            id="step-5"
          >
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-md mx-auto">
              A confirmation of your appointment has been sent to your email. Please bring a valid
              photo ID and any previous medical reports on the day of your visit.
            </p>
          ...
          {/* Back Button */}
          <button
            className={`absolute bottom-8 left-8 md:bottom-16 md:left-16 flex items-center text-on-surface-variant hover:text-secondary transition-colors font-label-caps text-[10px] tracking-widest cursor-pointer ${currentStep > 1 && currentStep < 5 ? "" : "hidden"}`}
            id="back-btn"
            onClick={prevStep}
          >
